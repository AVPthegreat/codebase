<template>
  <div class="setting-main">
      ...
      <template v-for="session in sessions">
        <Card :padding="20" class="flex-child">
          ...
          <div slot="extra">
            ...
            <Button v-else type="warning" size="small" @click="deleteSession(session.session_key)">Revoke
            </Button>
          </div>
    ...
    <div class="mini-container setting-content">
      <Form>
        <Alert v-if="TFAOpened" type="success" class="notice" showIcon>You have enabled two-factor authentication.
        </Alert>
        ...
        <template v-if="!loadingQRcode">
          ...
          <Button type="primary" :loading="loadingBtn" @click="updateTFA(false)" v-if="!TFAOpened">Open TFA
          </Button>
          <Button type="error" :loading="loadingBtn" @click="closeTFA" v-else>Close TFA
          </Button>
        </template>
      </Form>
    </div>
...
<style lang="less">
/* Dark mode styles for Security Settings */
.dark-mode {
  .setting-main {
    color: #c9d1d9;
