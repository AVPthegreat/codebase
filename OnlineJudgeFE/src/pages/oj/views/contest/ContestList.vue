              ...
              <Row type="flex" justify="space-between" align="top">
                  ...
                  <ul class="detail vertical">
                    ...
                    <li>
                      <Button
                        size="small"
                        shape="circle"
                        @click.stop="onRuleChange(contest.rule_type)"
                      >
                        {{ contest.rule_type }}
                      </Button>
                    </li>
                ...
                <Col :span="6" class="status-col">
                  <Tag
                    ...
                    >{{ statusLabel(contest.status) }}</Tag
                  >
                </Col>
              </Row>
            </Card>
    ...
    getContestList(page = 1) {
      ...
      api.getContestList(offset, this.limit, this.query).then((res) => {
        ...
        this.contests = contests.sort((a, b) => {
          ...
          return (
            (order[String(a.status)] || 999) - (order[String(b.status)] || 999)
          );
        });
    ...
    > li {
      ...
      .contest-card {
        ...
        /deep/ .ivu-card-body {
          ...
          display: flex;
          flex-direction: column;
          padding: 12px; /* Ensure padding is contained */
        }
        /* subtle lift */
        &:hover {
